...
def main(jsonlfname, prefix, start, end):
    ...
    for line in jsonl:
        ...
        xmlstr = '<?xml version="1.0" encoding="UTF-8" standalone="no"?>\n<!DOCTYPE ayliencov19 SYSTEM "ayliencov19.dtd"><ayliencov19>'
        xmlstr = xmlstr + dicttoxml.dicttoxml(data, attr_type=False, root=False, ids=True).decode("utf-8") + '</ayliencov19>\n'
