...
#Sun Jul 20 19:51:45 IST 2008
headers.home=/tmp/idxtest/data/eph
header.extension=hed
xquery.return.attribute.path=(speech|writing)/@ref
xquery.max.cache.size=23
frequency.table.name=fqtable.db
...
last.datafile.dir=/tmp/idxtest/data/ep
tpos.table.name=tptable.db
dictionary.environment.home=/tmp/idxtest/index
