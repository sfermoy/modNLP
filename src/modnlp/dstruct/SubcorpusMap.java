 ...
 * @version <font size=-1>$Id: SubcorpusMap.java,v 1.2 2006/05/22 17:26:02 amaral Exp $</font>
 * @see  
*/

public class SubcorpusMap extends HashMap {
  ...
  public void putDelimPair (String type, SubcorpusDelimPair pos) {
    put(type, pos);
  }
