...
public class MakeTermByDocMatrix {
   ...
   */
  public  MakeTermByDocMatrix(String clist, String swlist, String aggr) {
    super();
  ...
  throws Exception{
    ...
    if (method.equals("df")) {
      System.err.println("Filtering term set by document frequency (local)");
  ...
  public static void main(String[] args) {
    try {
      MakeTermByDocMatrix f = new MakeTermByDocMatrix(args[0],args[1],args[2]);
      ...
      //}
      //else 
      if (docRepresentation.equalsIgnoreCase("csv"))
        ARFFUtil.printTermByDocMatrixCSV(pm, rts, System.out);
      else
        System.err.print("\nInvalid representation scheme: "+docRepresentation);
    }
    catch (Exception e){
      System.err.println("\nUsage: MakeTermByDocMatrix CORPUS_LIST STOPWDLIST AGGRESSIVENESS TF_METHOD CATEG REPR");
      ...
      System.err.println(" REPR: document representation (one of {csv}\n");
